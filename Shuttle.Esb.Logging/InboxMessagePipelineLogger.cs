...
{
    public class InboxMessagePipelineLogger : IPipelineFeature
    {
        ...
        public InboxMessagePipelineLogger(ILogger<InboxMessagePipelineLogger> logger, IServiceBusLoggingConfiguration serviceBusLoggingConfiguration, IPipelineFactory pipelineFactory)
        {
            ...
            pipelineFactory.PipelineCreated += (sender, args) =>
            {
                ...
                args.Pipeline.RegisterObserver(new InboxMessagePipelineObserver(logger, serviceBusLoggingConfiguration));
            };
        }
    }
}