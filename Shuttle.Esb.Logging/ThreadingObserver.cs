    ...
    IDisposable
{
    ...
    {
        Wire(pipelineContext.Pipeline.State.Get<IProcessorThreadPool>("InboxThreadPool"));
        Wire(pipelineContext.Pipeline.State.Get<IProcessorThreadPool>("DeferredMessageThreadPool"));
        Wire(pipelineContext.Pipeline.State.Get<IProcessorThreadPool>("ControlInboxThreadPool"));
        Wire(pipelineContext.Pipeline.State.Get<IProcessorThreadPool>("OutboxThreadPool"));
